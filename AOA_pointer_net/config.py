...
flags.DEFINE_integer("embedding_size", 384, "Embedding dimension for AOA")
flags.DEFINE_integer("vocab_size",118652,"embedding corpus size")
flags.DEFINE_float("l2_reg",0.0001,'l2 regularization for embeddings')
flags.DEFINE_float("keep_prob", 0.9, "Dropout keep prob in rnn")
