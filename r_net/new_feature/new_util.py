...
def get_record_parser(config, is_test=False):
    def parse(example):
        ...
        context_feature = tf.reshape(tf.decode_raw(
            features["feature"], tf.int32), [para_limit, feature_dim])
        ...
        qa_id = features["id"]
        return context_idxs, ques_idxs, context_char_idxs, ques_char_idxs, y1, y2, qa_id, context_feature
