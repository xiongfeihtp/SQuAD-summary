...
char2idx_dict_file=os.path.join(target_dir,"char2idx_dict")
word_counter_file=os.path.join(target_dir,"word_counter")
char_counter_file=os.path.join(target_dir,"char_counter")
flags.DEFINE_string("word2idx_dict_file", word2idx_dict_file, "Out file for char embedding")
flags.DEFINE_string("char2idx_dict_file", char2idx_dict_file, "Out file for char embedding")
flags.DEFINE_string("word_counter_file", word_counter_file, "Out file for char embedding")
flags.DEFINE_string("char_counter_file", char_counter_file, "Out file for char embedding")
...
flags.DEFINE_boolean("use_in_question", False, "exact_match")
flags.DEFINE_boolean("use_pos", False, "pos feature")
flags.DEFINE_boolean("use_ner", False, "ner feature")
flags.DEFINE_boolean("use_tf", False, "ner feature")
